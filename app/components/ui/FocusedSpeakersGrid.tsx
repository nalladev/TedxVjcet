              ...
              >
                {!speaker.revealed ? (
                  ...
                  <div className="relative w-full h-full bg-[#161616] flex flex-col items-center justify-center">
                    <Image
                      src={`/${speaker.gender}_card.png`}
                      alt={`Speaker ${speaker.id} placeholder`}
                      fill
                    ...
                    />
                    <div className="absolute inset-0 flex flex-col items-center justify-center h-full bg-black/40 z-10">
