            ...
            >
              ...
              >
                {!speaker.revealed ? (
                  // Placeholder card
                  <div
                    className={`w-full h-full bg-[#161616] flex flex-col items-center justify-center transition-all duration-500 ${
                      !isFocused ? 'grayscale brightness-50' : ''
                    }`}
                    style={{
                      backgroundImage: `url(/${speaker.gender}_card.png)`,
                    ...
                    <div className="flex flex-col items-center justify-center h-full bg-black/40">
                      ...
                      {isFocused && (
                        <div className="text-center">
                          ...
                          <p className="text-white text-xs uppercase tracking-wider">Revealing Soon</p>
                        </div>
                      )}
                    </div>
                  </div>
            ...
            >
              ...
              >
                {!speaker.revealed ? (
                  // Placeholder card
                  <div
                    className={`w-full h-full bg-linear-to-br from-gray-800 to-gray-900 flex items-center justify-between px-4 transition-all duration-500 ${
                      !isFocused ? 'grayscale brightness-50' : ''
                    }`}
                    style={{
                      backgroundImage: `url(/${speaker.gender}_card.png)`,
